...
type ResumeData = { label:string; target?:string; template?:'classic'|'sidebar'|'compact'; theme?:'blue'|'emerald'|'violet'|'rose'|'slate'; settings?:{fontScale?:number;lineHeight?:number;blockGap?:number;pageMargin?:number}; sections?:{key:'summary'|'education'|'work'|'projects'|'skills'|'awards'|'certificates'|'languages'|'activities'|'interests';title?:string;hidden?:boolean}[]; basics:{name:string;title?:string;email?:string;phone?:string;location?:string;website?:string;github?:string;summary?:string;photo?:string}; education?:{school:string;college?:string;degree?:string;major?:string;period?:string;gpa?:string;courses?:string;detail?:string}[]; work?:{company:string;position?:string;period?:string;location?:string;highlights?:string[];projects?:Project[]}[]; projects?:Project[]; skills?:{category?:string;items:string[]}[]; awards?:{title:string;issuer?:string;date?:string}[]; certificates?:{name:string;issuer?:string;date?:string}[]; languages?:{name:string;level?:string}[]; activities?:{name:string;role?:string;period?:string;highlights?:string[]}[]; interests?:string[] };
